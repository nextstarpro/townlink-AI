      ...
      <div className="prose-copy space-y-8 text-text-body">
        ...
        <section>
          ...
          <p>
            ...
            within 30 days of the end of month one. We measure &quot;cleared&quot; as
            (a) the dollar value of missed calls that our system captured and turned into a
            booked appointment or a booked job on your calendar, plus (b) the dollar value
            of bookings generated by any one-time text-back campaign we ran during month
            one, using the client&apos;s own reported service average as the multiplier. The
            full measurement methodology is set out in the MSA and available on request.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            initiating arbitration. The prevailing party is entitled to recover reasonable
            attorneys&apos; fees and costs. <strong>Class actions are waived.</strong> Nothing
            in this section prevents either party from seeking injunctive relief in a
